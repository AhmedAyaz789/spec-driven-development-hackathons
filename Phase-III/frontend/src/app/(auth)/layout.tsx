...
export default function AuthLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="min-h-screen bg-background-dark flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative">
      {/* TODO button in the top-right corner */}
      <div className="absolute top-6 right-6">
        <Link href="/">
          <Button variant="secondary" size="md" className="font-extrabold text-xl tracking-tight">
            TODO APP
          </Button>
        </Link>
      </div>
